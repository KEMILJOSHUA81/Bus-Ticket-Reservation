...
//Output
-----WELCOME TO THE BUS TICKET RESERVATION SYSTEM-----
-----Read the Given Information Throughly-----

 Bus No: 1 AC: true Capacity: 30 Driver Name: John Route: Coimbator to Chennai Duration: 10
 Bus No: 2 AC: true Capacity: 50 Driver Name: Emil Route: Coimbator to Erode Duration: 5
 Bus No: 3 AC: true Capacity: 70 Driver Name: Joshua Route: Coimbator to Trichy Duration: 6
Press 1 to Book You're Tickets and 2 to Exit from the App:
1
